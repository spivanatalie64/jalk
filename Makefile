...
SUBLEVEL = 10
EXTRAVERSION =
NAME = JALK - Just Another Linux Kernel
...
# Based on Linux 7.0.10 with performance optimizations
$(info )
$(info   ============================================)
$(info     JALK - Just Another Linux Kernel $(VERSION).$(PATCHLEVEL).$(SUBLEVEL))
